    ...
    def test_ddr5_cmd_write(self):
        ...
        self.run_test(dut = phy,
            ...
            pad_checkers = {
                ...
                "sys8x_90_ddr": {
                    f'dq{i}': (phy.settings.cmd_latency + 1)*zeros + zeros + dq_pattern(i, dfi_data, "wrdata") + zeros
                            for i in range(8)
                },
                # below lines may be wrong
                "sys8x_ddr": {
                    "dqs0": (phy.settings.cmd_latency + 1) * zeros + '01010101'+'00000101' + '01010101'+'01010101' + '00010101'+'01010101' + zeros,
                },
            },
