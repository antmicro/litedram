...
class DDR5RCD01Shell(Module):
    ...
    def __init__(self,
        ...
        self.sync += pads_ingress_common.alert_n.eq(
            ~pads_ingress_common.alert_n)

        # Pass-through
        self.comb += self.pads_egress_A.qrst_n.eq(pads_ingress_common.drst_n)

        self.comb += self.pads_egress_A.qacs_a_n.eq(pads_ingress_A.dcs_n)
        self.comb += self.pads_egress_A.qaca_a.eq(pads_ingress_A.dca)
        self.comb += self.pads_egress_A.qacs_b_n.eq(pads_ingress_A.dcs_n)
        self.comb += self.pads_egress_A.qaca_b.eq(pads_ingress_A.dca)
        ...
        if pads_ingress_B is not None:
            ...
            self.comb += self.pads_egress_B.qacs_a_n.eq(pads_ingress_B.dcs_n)
            self.comb += self.pads_egress_B.qaca_a.eq(pads_ingress_B.dca)
            self.comb += self.pads_egress_B.qacs_b_n.eq(pads_ingress_B.dcs_n)
            self.comb += self.pads_egress_B.qaca_b.eq(pads_ingress_B.dca)
